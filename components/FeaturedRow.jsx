  ...
  return (
    <View>
      <View className="mt-4 flex-row items-center justify-between px-4">
        ...
        <Entypo name='chevron-right' color={'#00cc88'} size={20} />
      </View>
